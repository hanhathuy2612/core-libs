...
import com.hnh.enterprise.core.rest.response.ErrorResponse;
...
public class AppExceptionHandler {
     ...
     * @return a ResponseEntity containing an ErrorResponse with a BAD_REQUEST status
     */
    ...
    /**
     * Handles AppRuntimeException, which is a custom runtime exception for the application.
     * @param ex the exception that was thrown
     * @return a ResponseEntity containing an ErrorResponse with the status and message from the exception
     */
    ...
    /**
     * Handles AccessDeniedException, which is thrown when access to a resource is denied.
     * @param ex the exception that was thrown
     ...
     * @param ex the exception that was thrown
     * @return a ResponseEntity containing an ErrorResponse with an INTERNAL_SERVER_ERROR status
     */
     ...
     * @return a ResponseEntity containing an ErrorResponse with the specified status and exception message
     */
